...
<xsl:variable name="ProfileIDType" select="',TICARIFATURA,TEMELFATURA,YOLCUBERABERFATURA,'"/>
   ...
   <xsl:variable name="TaxType"
                 select="',0003,0015,0061,0071,0073,0074,0075,0076,0077,1047,1048,4080,4081,9015,9021,9077,8001,8002,8003,8004,8005,8006,8007,8008,9040,0011,4171,'"/>
...
<xsl:choose>
   ...
   <xsl:template match="@*|node()" priority="-2" mode="M20">
	  ...
	  <!--RULE -->
<xsl:template match="//cbc:IdentificationCode" priority="1008" mode="M0">

		<!--ASSERT -->
<xsl:choose>
         <xsl:when test="contains($CountryCodeList,.)"/>
         <xsl:otherwise>Geçersiz <xsl:text/>
            <xsl:value-of select="name(.)"/>
            <xsl:text/> elemanı değeri:<xsl:text/>
            <xsl:value-of select="."/>
	  ...
	  <!--RULE -->
<xsl:template match="//cbc:SourceCurrencyCode" priority="1007" mode="M0">

		<!--ASSERT -->
<xsl:choose>
         <xsl:when test="contains($CurrencyCodeList,.)"/>
         <xsl:otherwise>Geçersiz <xsl:text/>
            <xsl:value-of select="name(.)"/>
            <xsl:text/> elemanı değeri:<xsl:text/>
            <xsl:value-of select="."/>
	  ...
	  <!--RULE -->
<xsl:template match="//cbc:TargetCurrencyCode" priority="1006" mode="M0">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cbc:CurrencyCode" priority="1005" mode="M0">
...
<xsl:choose>
   ...
   <!--PATTERN package-->
	...
	<!--RULE -->
<xsl:template match="ef:Package" priority="1001" mode="M25">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="ef:Package/Elements" priority="1000" mode="M25">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="inv:Invoice" priority="1020" mode="M26">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="inv:Invoice/cbc:UUID" priority="1019" mode="M26">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="inv:Invoice/cac:Signature" priority="1018" mode="M26">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="inv:Invoice/cac:TaxTotal/cac:TaxSubtotal" priority="1009" mode="M26">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="inv:Invoice/cac:TaxTotal/cbc:TaxAmount" priority="1001" mode="M26">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="inv:Invoice/cac:Signature/cac:SignatoryParty" priority="1000" mode="M26">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apr:ApplicationResponse" priority="1011" mode="M27">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apr:ApplicationResponse/cac:Signature" priority="1010" mode="M27">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apr:ApplicationResponse/cbc:UUID" priority="1009" mode="M27">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apr:ApplicationResponse/cac:SenderParty" priority="1006" mode="M27">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apr:ApplicationResponse/cac:ReceiverParty" priority="1003" mode="M27">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="apr:ApplicationResponse/cac:DocumentResponse" priority="1002" mode="M27">
...
<xsl:choose>
   ...
   <!--PATTERN processuseraccount-->
	...
	<!--RULE -->
<xsl:template match="hr:ProcessUserAccount/oa:ApplicationArea" priority="1011" mode="M28">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hr:ProcessUserAccount/hr:DataArea" priority="1001" mode="M28">
...
<xsl:choose>
   ...
   <!--PATTERN canceluseraccount-->
	...
	<!--RULE -->
<xsl:template match="hr:CancelUserAccount/oa:ApplicationArea" priority="1011" mode="M29">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="hr:CancelUserAccount/hr:DataArea" priority="1001" mode="M29">

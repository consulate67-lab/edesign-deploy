              ...
              <b>
                <span style="font-size:10pt; color:black;"
                  ...
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <xsl:text>SATILAN KIYMETLİ MADENE AİT BİLGİLER</xsl:text>
                    </xsl:otherwise>
                  </xsl:choose>
                  </span>
              </b>
              ...
              <td>
                <table>
                  <xsl:choose>
                    ...
                    <xsl:when test="/n1:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015'">
                      <tr id="budgetContainerTr">
                        <td/>
                        <td id="lineTableBudgetTd" width="150px">
                          <span style="font-weight:bold; ">
                      ...
                      <tr id="budgetContainerTr">
                        ...
                        <td id="lineTableBudgetTd" style="width:81px; " align="right">
                          <xsl:for-each select="//n1:CreditNote/cac:PricingExchangeRate">
                            <xsl:value-of
                              select="format-number(1 div cbc:CalculationRate, '###.##0,00', 'european')"
